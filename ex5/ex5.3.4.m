...
%Now carry out the same task but unexpectedly remove the environment (you can simply
%set its position out of the manipulator’s reach via setting Environment.cf_e_.Matrix).
%What happens?

%It explodes, the only way to generate the force is to accelerate.
